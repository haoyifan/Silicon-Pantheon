...
class SharedState:
    ...
    # Persist the lobby sub-view ("rooms" | "ranking"), the selected
    # ranking row, and both scroll offsets across screen transitions —
    # otherwise going back from the model-details screen resets the
    # user's position.
